...
"""
  ...
  This function creates a standard HnswApi with pre-defined distances. 
...
* NOTE:
    It is not possible to dump/reload a HnswApi with a custom distance generated by
    the macro @cfunction in the current version.
"""
function fileDump(hnsw::HnswApi,  filename::String)
